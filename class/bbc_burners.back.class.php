 ...
 *		\remarks	Initialy built by build_class_from_table on 2012-09-28 12:30
 */
class Bbc_burners // extends CommonObject
{
    ...
    function create($user, $notrigger=0)
    {
		...
		if (isset($this->framemodel)) $this->framemodel=trim($this->framemodel);
		if (isset($this->framenumber)) $this->framenumber=trim($this->framenumber);
