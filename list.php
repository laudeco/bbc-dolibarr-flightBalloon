...
$contextpage= GETPOST('contextpage','aZ')?GETPOST('contextpage','aZ'):'llx_bbc_ballonslist';   // To manage different context of search
...
if ($user->rights->hello->delete) $arrayofmassactions['delete']=$langs->trans("Delete");
